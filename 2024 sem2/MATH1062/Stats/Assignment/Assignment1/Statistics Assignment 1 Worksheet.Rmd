...
**`Answer to Task 2.3:`** (Write your answer here.) Yes.
...
**`Answer to Task 3.1:`** (Write your answer here.) 

## **`Task 3.2`** {-}

In the following code block, calculate the 30% percentile of the population of chick weights based on the normal curve constructed above. Please also provide your answer after the **`Answer to Task 3.2`** prompt provided below, rounding your answer (in percentage) to two decimal places.
...
**`Answer to Task 3.2:`** (Write your answer here.)  171.39.
